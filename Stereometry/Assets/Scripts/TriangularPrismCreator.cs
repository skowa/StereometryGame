...
{
    public class TriangularPrismCreator : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            _points = new[]
            {
            new Vector3(-2f, -2f, -1.8f),
            new Vector3(0.9f, -2f, -1.8f),
            new Vector3(0.9f, -2f, 1.8f),
            new Vector3(-1.2f, 2f, -1.8f),
            ...
            _points[1], _points[3], _points[5],
            _points[1], _points[4], _points[5],
            _points[1], _points[2], _points[4],
            ...
            AssetDatabase.CreateAsset(mesh, "Assets/Resources/Meshes/Prism");
            ...
            _edges = new List<Line>
        {
            ...
            new Line(_points[0], _points[3]),
            new Line(_points[1], _points[2]),
            new Line(_points[1], _points[5]),
            new Line(_points[2], _points[4]),
            new Line(_points[3], _points[4]),
            new Line(_points[3], _points[5]),
            new Line(_points[4], _points[5])
        };
        }
    }
}
